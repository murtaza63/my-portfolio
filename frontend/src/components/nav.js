        ...
        <>
            <div className='hidden md:block sticky top-0'>
                <ul className='flex bg-stone-100 cursor-pointer'>
                    <li className='mx-3 my-4 text-2xl text-slate-900 hover:text-slate-700 transition' onClick={() => executeScroll(homeRef)}>Ghulam Murtaza</li>
            ...
            <div className='md:hidden block sticky top-0'>
                <div className='flex justify-between w-100 bg-stone-100 cursor-pointer'>
                    <div className='mx-3 my-4 text-2xl text-slate-900 hover:text-slate-700 transition' onClick={() => executeScroll(homeRef)}>Ghulam Murtaza</div>
                ...
                <div className={toggleMenue ? '' : 'hidden'}>
